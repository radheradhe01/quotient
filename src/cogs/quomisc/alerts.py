...
class PromptView(QuotientView):
    ...
    async def read_now(self, inter: discord.Interaction, btn: discord.Button):
        try:
            ...
            print(f"Error in read_now button: {e}")
            await inter.followup.send("Failed to process alert read. Please try again.", ephemeral=True)
    ...
    async def dismiss(self, inter: discord.Interaction, btn: discord.Button):
        try:
            ...
            print(f"Error in dismiss button: {e}")
            await inter.followup.send("Failed to dismiss alert. Please try again.", ephemeral=True)
...
class CreateAlert(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        try:
            ...
            print(f"Error in CreateAlert callback: {e}")
            await interaction.followup.send("Failed to create alert. Please try again.", ephemeral=True)
...
class QuoAlerts(Cog):
    ...
    async def on_command_completion(self, ctx: Context):
        ...
        try:
            # Safety check: ensure database is ready
            ...
            print(f"Error in alerts on_command_completion: {e}")
            return
    ...
    async def on_alert_timer_complete(self, timer: Timer):
        try:
            ...
            print(f"Error in on_alert_timer_complete: {e}")
            return
    ...
    async def alr_list(self, ctx: Context):
        try:
            ...
            print(f"Error in alr_list command: {e}")
            await ctx.error("Failed to list alerts. Please try again.")
    ...
    async def alr_create(self, ctx: Context):
        try:
            ...
            print(f"Error in alr_create command: {e}")
            await ctx.error("Failed to create alert interface. Please try again.")
